...
return array (
  ...
  'page_title_1' => 'شراء ، بيع ، تأجير العقارات في دبي',

  'page_title_2' => 'عقارات للبيع | شقق للبيع | فيلل للبيع ',
  'apartment_for_sale' => 'شقق للبيع | عقارات في دبي للبيع',
  'villa_for_sale' => 'فيلل للبيع | عقارات في دبي للبيع',
  'commercial_for_sale' => 'عقارات تجارية للبيع | عقارات للبيع في دبي ',
  'properties_for_sale_in' => 'عقارات للبيع في  ',
  'properties_for_sale_in_dubai' => 'عقارات للبيع في دبي | شقق للبيع في دبي | فيلل للبيع في دبي',

  'page_title_3' => 'عقارات للايجار | شقق للايجار | فيلل للايجار',
  'apartment_for_rent' => 'شقق للايجار | عقارات للايجار في دبي',
  'villa_for_rent' => 'فيلل للايجار | عقارات في دبي للايجار',
  'commercial_for_rent' => 'عقارات تجارية للايجار | عقارات للايجار في دبي',
  'properties_for_rent_in' => 'عقارات للايجار في ',
  'properties_for_rent_in_dubai' => 'عقارات للايجار في دبي | شقق للايجار في دبي | فيلل للايجار في دبي',

  'page_title_4' => 'مشروعات جديدة في دبي | شقق جديدة للبيع | فيلل جديدة للبيع | عقارات تجارية جديدة للبيع',
  'projects_by_developer' => 'مشروعات جديدة من المطور :',
  'projects_by_type' => 'مشروعات جديدة على حسب الطراز :',
  'projects_by_status' => 'مشروعات جديدة على حسب الحالة :',

  'page_title_5' => 'مناطق دبي',
