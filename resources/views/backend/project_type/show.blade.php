        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Project_type</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 150px;">
                        <a href="{{url('admin/project_type/create')}}" class="btn btn-block btn-secondary"><i class="fas fa-plus-circle"></i> Add New Type</a>
