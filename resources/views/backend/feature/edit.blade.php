                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="{{url('admin/features/update/'.$feature->id)}}" enctype="multipart/form-data">
                                @csrf
                                @honeypot
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            {!! Form::text('name_en',$feature->name_en, array('placeholder' => '','class' => 'form-control','id'=>'name_en','required'=>'')) !!}
                                        </div>
                                        <div class="col-sm-4">
                                            <label for="exampleInputName">Feature Name [ Russian ]</label>
                                            {!! Form::text('name_ru',$feature->name_ru, array('placeholder' => '','class' => 'form-control','id'=>'name_ru','required'=>'')) !!}
                                        </div>
                                        <div class="col-sm-4">
                                            <label for="exampleInputName">Feature Name [ العربية ]</label>
                                            {!! Form::text('name_ar',$feature->name_ar, array('placeholder' => '','class' => 'form-control','id'=>'name_ar','required'=>'', 'dir'=>'rtl')) !!}
