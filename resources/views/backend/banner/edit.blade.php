                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            {!! Form::text('title',$banner->title_en, array('placeholder' => '','class' => 'form-control','id'=>'title','required'=>'')) !!}
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            {!! Form::text('link_url',$banner->link_url_en, array('placeholder' => '','class' => 'form-control','id'=>'link_url','required'=>'')) !!}
                                    ...
                                    <div class="form-group col-sm-2">
                                        ...
                                        <img src="{{ URL::asset('uploads/banners/'.'/'.$banner->image) }}" style="object-fit: scale-down;" alt="Listing" height="250px" width="400px">
