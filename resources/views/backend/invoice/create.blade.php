                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::text('unit_price_2','', array('class' => 'form-control','id'=>'phone', 'placeholder'=>'maximum 999,999,999')) !!}
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="name" class="col-sm-4 form-control-label">Amount 2 </label>
                                            <div class="col-sm-12">
                                                {!! Form::text('amount_2','', array('class' => 'form-control','id'=>'phone', 'placeholder'=>'maximum 999,999,999')) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::text('unit_price_3','', array('class' => 'form-control','id'=>'phone', 'placeholder'=>'maximum 999,999,999')) !!}
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="name" class="col-sm-4 form-control-label">Amount 3 </label>
                                            <div class="col-sm-12">
                                                {!! Form::text('amount_3','', array('class' => 'form-control','id'=>'phone', 'placeholder'=>'maximum 999,999,999')) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::text('unit_price_4','', array('class' => 'form-control','id'=>'phone', 'placeholder'=>'maximum 999,999,999')) !!}
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="name" class="col-sm-4 form-control-label">Amount 4 </label>
                                            <div class="col-sm-12">
                                                {!! Form::text('amount_4','', array('class' => 'form-control','id'=>'phone', 'placeholder'=>'maximum 999,999,999')) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::text('unit_price_5','', array('class' => 'form-control','id'=>'phone', 'placeholder'=>'maximum 999,999,999')) !!}
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="name" class="col-sm-4 form-control-label">Amount 5 </label>
                                            <div class="col-sm-12">
                                                {!! Form::text('amount_5','', array('class' => 'form-control','id'=>'phone', 'placeholder'=>'maximum 999,999,999')) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::text('description_3','', array('class' => 'form-control','id'=>'phone')) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::text('description_4','', array('class' => 'form-control','id'=>'phone')) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::text('description_5','', array('class' => 'form-control','id'=>'phone')) !!}
                                            </div>
                                        </div>
