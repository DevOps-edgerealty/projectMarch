                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::text('amount',$invoice->gross_amount, array('class' => 'form-control','id'=>'phone','required'=>'')) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                {!! Form::text('gross_amount_2',$invoice->gross_amount_2, array('class' => 'form-control','id'=>'phone')) !!}
                                            </div>
                                        </div>
