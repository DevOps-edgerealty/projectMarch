...
,
        ...
        // earthquakes.features.forEach(function (store, i) {
        ...
        function buildLocationList(stores) {
            for (const store of stores.features) {
                ...
                listing.id = `listing-${store.properties.STATION_NO}`;
                ...
                link.id = `link-${store.properties.STATION_NO}`;
                link.innerHTML = `${store.properties.STATION_NAME}`;
                ...
                link.addEventListener('click', function () {
                    for (const feature of earthquakes.features) {
                        if (this.id === `link-${feature.properties.STATION_NO}`) {
                            flyToStore(feature);
                            // createPopUp(feature);
                        }
                    }
        ...
        map.on('load', () => {
            ...
            map.on('click', 'unclustere-point', (e) => {
            ...
            map.on('mouseenter', 'unclustered-point', (e) => {
                ...
                popup.setLngLat(coordinates).setHTML('<a id="popupId" href="https://www.edgerealty.ae">Link To Property</a>').addTo(map);
            });
