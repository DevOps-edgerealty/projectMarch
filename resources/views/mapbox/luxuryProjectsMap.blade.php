        ...
        <div class="container">
            ...
            <div class="row mx-auto mb-3">
                ...
                <div class="d-flex bd-highlight px-0    ">
                    ...
                    <div class="p-2 flex-fill bd-highlight d-none d-md-block d-lg-block text-center" style="font-size: 1.8rem; text-align: center !important; ">{{ trans('frontLang.dubaiLuxuryProjects') }}</div>
