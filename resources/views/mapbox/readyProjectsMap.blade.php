        ...
        <div class="container">
            ...
            <div class="row mx-auto mb-3">
                <span class=" mx-auto text-center d-block d-sm-block d-md-none" style="font-size: 1.3rem; text-align: center !important; margin: auto !imp">
                    {{ trans('frontLang.dubaiReadyProjects') }}
                </span>
                ...
                <div class="d-flex bd-highlight px-0    ">
                    ...
                    <div class="p-2 flex-fill bd-highlight d-none d-md-block d-lg-block text-center" style="font-size: 1.8rem; text-align: center !important; ">{{ trans('frontLang.dubaiReadyProjects') }}</div>
        ...
        map.on('load', () => {
            ...
            map.on('click', 'unclustered-point', (e) => {
                ...
                if( isMobile.any() ) {
                    ...
                    document.getElementById('listing-btn-mobile').innerHTML = `<a href="{{url('en/dubai-ready-projects/${slug_link}')}}" class="btn btn-outline-white btn-block rounded-0 text-white">View Property</a>`;
                    ...
                    */
                    ...
                    document.getElementById('listing-btn').innerHTML = `<a href="{{url('en/dubai-ready-projects/${slug_link}')}}" class="btn btn-outline-white rounded-0 text-white">View Property</a>`;
