        ...
        <div id="intro-page" class="bg-image shadow-2-strong">
            ...
            <div class="container d-flex align-items-center justify-content-center text-center h-100" style="margin-top: 40px;">
                <div class="text-white">
                    <h3 style="text-transform: uppercase;">Onilne Payments</h3>
                </div>
            </div>
            </div>
        </div>
...
<section class="mt-5">
    <div class="container">
        ...
        <h3 class="text-left">Onilne Payments</h3>
                        ...
                        <fieldset class="wizard-fieldset show">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control wizard-required" id="fname">
                                        <label for="fname" class="wizard-form-text-label">Mobile Number*</label>
                                        <div class="wizard-form-error"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control wizard-required" id="lname">
                                        <label for="lname" class="wizard-form-text-label">Address*</label>
                                        <div class="wizard-form-error"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <select name="country_of_rest"  class="form-control wizard-required">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control wizard-required" id="lname">
                                        <label for="lname" class="wizard-form-text-label">Passport Number*</label>
                                        <div class="wizard-form-error"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <label for="lname" class="wizard-form-text-label-2">Expiry Date*</label>
                                        <div class="wizard-form-error"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <select name="country_of_rest"  class="form-control wizard-required">
                                            ...
                                            <option value="Afghanistan">OFF-Plan</option>
                                            <option value="Albania">Ready</option>
                                            <option value="Albania">Rental</option>
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="number" class="form-control wizard-required" id="lname">
                                        <label for="lname" class="wizard-form-text-label">Amount in AED*</label>
                                        <div class="wizard-form-error"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control wizard-required" id="fname">
                                        <label for="fname" class="wizard-form-text-label">Project Name*</label>
                                        <div class="wizard-form-error"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control wizard-required" id="lname">
                                        <label for="lname" class="wizard-form-text-label">Apartment Number*</label>
                                        <div class="wizard-form-error"></div>
                                    </div>
                                </div>
