...
@section('meta_detail')
    ...
    <title> Best Real Estate Agent in Dubai | Edge Realty Dubai </title>
    <meta name="description" content=" We are the Experienced &amp; Qualified Dubai Real Estate Agents. we can assist you to Buy, Sell leasing and Renting properties in Dubai. "/>
...
<section class="mt-5">
    <div class="container-fluid containerization">
        ...
        <div class="row text-center" style="direction: rtl">
            <h3 >{{ trans('frontLang.lookingforjob') }}</h3>
            <p style="font-size: 16px;line-height: 25px">
                ليس لدينا حاليًا وظائف شاغرة محددة ، ولكننا نبحث دائمًا عن الأفراد المتحمسين الذين لديهم شغف بالعمل في مجال العقارات ، والذين يمكنهم تقديم مستوى متميز من الخدمة لعملائنا ، إذا كنت تعتقد أن لديك الاستعداد لتصبح نجمًا ساطعًا في شركة إيدج ريالتي ، يرجى إرسال سيرتك الذاتية إلى قسم الموارد البشرية على <a href="mailto:hr@edgerealty.ae">hr@edgerealty.ae</a> أو ملء النموذج أدناه.
            </p>
        </div>
        ...
        <div class="row text-center">
            <h3 >{{ trans('frontLang.lookingforjob') }}</h3>
            <p style="font-size: 16px;line-height: 25px">
                В настоящее время у нас нет конкретных вакансий, но мы всегда в поиске целеустремленных людей, которые страстно любят недвижимость и могут предложить нашим клиентам выдающийся уровень обслуживания. Если Вы думаете, что у Вас есть все необходимое, чтобы стать звездой в Edge Realty, пожалуйста, отправьте свое резюме в отдел кадров по электронной почте hr@edgerealty.ae или заполните приведенную ниже форму.
            </p>
        </div>
        ...
        @else
            <div class="row text-center">
                <h3 >{{ trans('frontLang.lookingforjob') }}</h3>
                <p style="font-size: 16px;line-height: 25px">
                    We currently have no specific vacancies, but we are always on the lookout for motivated individuals who have a passion for property, and who can offer an outstanding level of service to our clients.If you think you have what it takes to become a shining star at Edge Realty, then please send your CV to the HR Department at <a href="mailto:hr@edgerealty.ae">hr@edgerealty.ae</a> or fill the below form.
                </p>
            </div>
        @endif
            ...
            <div class="row">
                    ...
                    {{-- <div class="col-lg-12 mb-4">
                        <select name="category" class="form-select form-select-lg" aria-label="Default select example">
                            ...
                            <option value="Sales and Leasing"> المبيعات والتأجير</option>
                            <option value="Off Plan">مشروعات تحت الإنشاء</option>
                    ...
                    <div class="col-lg-6">
                        <div class=" mb-4">
                            <select name="nationality" class="form-select form-select-lg" aria-label="Default select example">
                    ...
                    <div class="col-lg-6">
                        <div class=" mb-4">
                            <input type="text" name="language" class="form-control form-control-lg" placeholder="لغة"  required />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <!-- Email input -->
                        <div class="mb-4">
                            <input class="form-control form-control-lg" type="file" id="myFile" name="file_name" accept="application/pdf"  required />
                        </div>
                    </div>
            ...
            <div class="row">
                    ...
                    {{-- <div class="col-lg-12 mb-4">
                        <select name="category" class="form-select form-select-lg" aria-label="Default select example">
                            ...
                            <option value="Sales and Leasing">Продажи и лизинг</option>
                            <option value="Off Plan">Недвижимость на этапе строительства</option>
                    ...
                    <div class="col-lg-6">
                        <div class=" mb-4">
                            <input type="text" name="language" class="form-control form-control-lg" placeholder="Язык"  required />
                        </div>
                    </div>
            ...
            <div class="row">
                    ...
                    {{-- <div class="col-lg-12 mb-4">
                        <select name="category" class="form-select form-select-lg" aria-label="Default select example">
                            ...
                            <option value="Sales and Leasing">Sales and Leasing</option>
                    ...
                    <div class="col-lg-6">
                        <div class=" mb-4">
                            <input type="text" name="language" class="form-control form-control-lg" placeholder="Language"  required />
                        </div>
                    </div>
