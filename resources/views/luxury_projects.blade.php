                                ...
                                <div class="col-lg-6" style="width: 50%">
                                    <div class="row mt-2">
                                        <ul style="color: white" class="font-ul">
                                            ...
                                            @else
                                                <li class="text-white">{{ trans('frontLang.Price') }}   : {{ trans('frontLang.AED') }} <span style="color: #848484">{{$projects->project_price}}</span> </li>
                                            @endif
                                ...
                                <div class="col-lg-6" style="width: 50%">
                                    <div class="row mt-2">
                                        <ul style="color: #848484" class="font-ul">
                                            <li class="" style="color: #848484 !important">{{ trans('frontLang.projectType') }} :<span style="color: #848484"> @foreach ($projects->project_types as $project_type)
                                                {{$project_type->$type_title_var}}
                                            @endforeach </span></li>
                                            <li class="" style="color: #848484 !important">{{ trans('frontLang.floorNo') }} : <span style="color: #848484"> {{$projects->no_floors}}</span></li>
                                            <li class="" style="color: #848484 !important">{{ trans('frontLang.unitsize') }} : <span style="color: #848484"> {{$projects->size}}</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
